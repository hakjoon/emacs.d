(defun color-theme-cl-frame ()
  ...
  (color-theme-install
   '(color-theme-cl-frame
     ...
     (mode-line-inactive ((t (:background "gray20" :foreground "gray60" :box (:line-width -1 :color "gray40")))))
     (modeline-buffer-id ((t (:foreground "Gold2" :bold t :weight bold))))
     ...
     (org-level-1 ((t (:bold t :foreground "gold" :weight bold))))
     (org-level-2 ((t (:bold t :foreground "gray80" :weight bold))))
     (org-level-3 ((t (:bold t :foreground "gray60" :weight bold))))
