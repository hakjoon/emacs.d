;;; color-theme-hakjoon.el --- Patrick Woods color theme
...
;;; This theme is based on hober2 by Edward O'Connor <ted@oconnor.cx>
...
(defun hakjoon-use-underline-p (&optional display)
...
(defvar hakjoon-insignificant-face
  (if window-system
     '(:foreground "gray30")
   '()))

;; Ensuring `max-lisp-eval-depth' and `max-specpdl-size' are big enough
;; for the backquote in `color-theme-hakjoon', as well as for running
...
(defun color-theme-hakjoon ()
  "Based on Hober2 Color theme by Edward O'Connor <ted@oconnor.cx>.
...
speedbar, tex, view, viper, w3m, widget, woman"
  ...
  (color-theme-install
   `(color-theme-hakjoon
     ...
     (dired-ignored ((t ,hakjoon-insignificant-face)))
     (dired-face-boring ((t ,hakjoon-insignificant-face)))
     (dired-face-permissions ((t ,hakjoon-insignificant-face)))
     (dired-face-setuid ((t (:bold t :foreground "medium sea green"))))
     (dired-face-socket ((t ,hakjoon-insignificant-face)))
     ...
     (erc-fool-face ((t ,hakjoon-insignificant-face)))
     ...
     (escape-glyph ((t ,hakjoon-insignificant-face)))
     ...
     (eshell-ls-product-face ((t ,hakjoon-insignificant-face)))
     (eshell-ls-product ((t ,hakjoon-insignificant-face)))
     (eshell-ls-readonly-face ((t ,hakjoon-insignificant-face)))
     (eshell-ls-readonly ((t ,hakjoon-insignificant-face)))
     ...
     (file-name-shadow ((t ,hakjoon-insignificant-face)))
     ...
     (font-latex-sedate-face ((t ,hakjoon-insignificant-face)))
     ...
     (gnus-header-content-face ((t ,hakjoon-insignificant-face)))
     (gnus-header-content ((t ,hakjoon-insignificant-face)))
     ...
     (gnus-signature-face ((t ,hakjoon-insignificant-face)))
     (gnus-signature ((t ,hakjoon-insignificant-face)))
     ...
     (nxml-processing-instruction-delimiter-face ((t ,hakjoon-insignificant-face)))
     (nxml-processing-instruction-delimiter ((t ,hakjoon-insignificant-face)))
     ...
     (nxml-cdata-section-delimiter-face ((t ,hakjoon-insignificant-face)))
     (nxml-cdata-section-delimiter ((t ,hakjoon-insignificant-face)))
     ...
     (nxml-tag-delimiter-face ((t ,hakjoon-insignificant-face)))
     (nxml-tag-delimiter ((t ,hakjoon-insignificant-face)))
     (nxml-tag-slash-face ((t ,hakjoon-insignificant-face)))
     (nxml-tag-slash ((t ,hakjoon-insignificant-face)))
     ...
     (nxml-markup-declaration-delimiter-face ((t ,hakjoon-insignificant-face)))
     (nxml-markup-declaration-delimiter ((t ,hakjoon-insignificant-face)))
     ;; (nxml-hash-face ((t ())))
     ;; (nxml-hash ((t ())))
     ;; (nxml-glyph-face ((t ())))
     ;; (nxml-glyph ((t ())))
     ...
     (paren-face ((t ,hakjoon-insignificant-face)))
     ...
     (rng-error-face ((t ,(if (hakjoon-use-underline-p)
                              '(:underline "red")
     ...
     (shadow ((t ,hakjoon-insignificant-face)))
     ...
     (slime-reader-conditional-face ((t ,hakjoon-insignificant-face)))
     ...
     (widget-inactive-face ((t ,hakjoon-insignificant-face)))
...
(provide 'color-theme-hakjoon)

;;; color-theme-hakjoon.el ends here
